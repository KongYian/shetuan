            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<?php echo U('showdepartapply');?>" data-index="0">新社团申请</a>
                        </li>
                    </ul>
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<?php echo U('showactivity');?>" data-index="0">新活动申请</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<?php echo U('showuserapply');?>" data-index="0">新用户</a>
                        </li>
                    </ul>
                </li>
            </ul>
