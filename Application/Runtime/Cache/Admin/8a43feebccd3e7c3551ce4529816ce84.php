                ...
                <table class="table table-striped table-bordered table-hover dataTables-example">
                    ...
                    <?php if(is_array($res)): foreach($res as $k=>$value): ?><tr class="gradeX">
                            ...
                            <td data-id="<?php echo ($value["messageid"]); ?>">
                                <a href="<?php echo U('Message/messagemodify',array('id'=>$value['messageid']));?>">
                                <button class="btn btn-sm btn-info messagemodify">修改</button></a>
                                <button class="btn btn-sm btn-danger messagedel">删除</button>
                            </td>
...
<script>
    $('.messagedel').on('click',function () {
        ...
        var url = "<?php echo U('Message/messagedel');?>";
        $.ajax({
            url: url,
            data: param,
            dataType: 'json',
